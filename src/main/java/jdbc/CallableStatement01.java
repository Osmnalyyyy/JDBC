...
public class CallableStatement01 {
    /*
    java'da methodlar return type sahibi olsada void olsa da method olarak adlandırılır
    SQL de ise data return ediyorsa buna "function" denir.return yapmıyorsa "procedure" diye adlandırılır
